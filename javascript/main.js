...
function changeStyle(){
  document.getElementById("btn").style.fontSize = "10rem";
  document.getElementById("btn").style.textIndent = "0%";
...
function changeBack(){
  document.getElementById("btn").style.fontSize = "0rem";
  document.getElementById("btn").style.textIndent = "120%";
